    ...
    <main className="app-shell">
      <aside className="sidebar">
        ...
        <nav className="main-nav" aria-label="Main navigation">
          ...
          <button onClick={() => { setStorageProgress(""); refreshStorageInfo().catch(() => undefined); setShowStorage(true); }} className="nav-item"><span>◈</span> Storage health {pendingBulkImport?.conflicts.length ? <b className="inbox-count">{pendingBulkImport.conflicts.length}</b> : null}</button>
